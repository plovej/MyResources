...
//        PathplanningActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
//                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(PathplanningActivity.ROUTE_PLAN_NODE);
...
//        PathplanningActivity.activityList.remove(this);
