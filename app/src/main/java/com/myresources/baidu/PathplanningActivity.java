 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class PathplanningActivity extends MyBaseActivity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener {
    ...
    public void searchButtonProcess(View v) {
        ...
        EditText editstText = (EditText) findViewById(R.id.startchengshi);
        EditText editEn = (EditText) findViewById(R.id.end);
        EditText editentext = (EditText) findViewById(R.id.endchengshi);
...
//            mSearch.transitSearch((new TransitRoutePlanOption())
//                    .from(stNode).city(editstText.getText().toString()).to(enNode).city(editentext.getText().toString()));
    ...
    boolean useDefaultIcon = false;//是否显示自己的图片 false为显示默认图片
