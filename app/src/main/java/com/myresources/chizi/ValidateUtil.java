...
public class ValidateUtil {
	...
	// 密码的正则 密码{6-12}。由[a-z]，[A-Z]，[0-9] 组成
	private final static String DEFAULT_USERNAME_PATTERN = "^[0-9_a-zA-Z]{6,20}$";

	// 密码的正则 密码{6-12}。由[a-z]，[A-Z]，[0-9] 组成
	private final static String DEFAULT_PWD_PATTERN = "^[0-9_a-zA-Z]{6,12}$";
	...
	public static boolean isValidPwd(String pwd) {
		...
		Pattern p = Pattern.compile(DEFAULT_PWD_PATTERN);
	...
	public static boolean isValidUserName(String userName) {
		...
		Pattern p = Pattern.compile(DEFAULT_USERNAME_PATTERN);
